...
import { removeTrailingSlash } from "@/app/utiles/common";
...
export function BlogDetail({ data, types }) {
  ...
  return (
    <HelmetWrapper>
      ...
      /> */}
        <link rel="canonical" href={`${removeTrailingSlash(currentUrl)}`} />
        <meta
          property="og:image"
          content={data?.data?.soft_image || "Default OG Image URL"}
        />
